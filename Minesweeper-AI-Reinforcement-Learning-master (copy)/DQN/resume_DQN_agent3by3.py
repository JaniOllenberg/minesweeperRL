...
# DQN settings
CONV_UNITS = 16 # number of neurons in each conv layer
DENSE_UNITS = 16 # number of neurons in fully connected dense layer
UPDATE_TARGET_EVERY = 5

# Default model name
# MODEL_NAME = f'conv{CONV_UNITS}x2_dense{DENSE_UNITS}x2_y{DISCOUNT}_minlr{LEARN_MIN}_beginner_batch{BATCH_SIZE}_decay0999975_mine{EPSILON_MIN}'
# MODEL_NAME = f'conv{CONV_UNITS}x2_dense{DENSE_UNITS}x2_y{DISCOUNT}_minlr0.001_beginner_batch{BATCH_SIZE}_decay0999975_mine{EPSILON_MIN}'
MODEL_NAME = f'conv16x2_dense16x2_y0.1_minlr0.001_beginner_batch64_decay0999975_mine0.01'
